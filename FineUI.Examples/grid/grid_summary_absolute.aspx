...
<body>
    <form id="form1" runat="server">
        ...
        <f:Grid ID="Grid1" Title="表格" EnableFrame="true" EnableCollapse="true" Width="800px" Height="350px" PageSize="10" ShowBorder="true"
        ...
        <f:HiddenField runat="server" ID="hfGrid1Summary">
        </f:HiddenField>
        <br />
